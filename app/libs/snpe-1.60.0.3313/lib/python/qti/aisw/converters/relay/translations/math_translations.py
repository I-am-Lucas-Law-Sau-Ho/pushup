...
class RelayElementwisePowerTranslation(RelayElementwiseBinaryBaseTranslation):
    def __init__(self):
        super(RelayElementwisePowerTranslation, self).__init__(ElementwisePowerOp)
...
class RelayElementwiseUnaryRsqrtTranslation(RelayElementwiseUnaryBaseTranslation):
    def __init__(self):
        super(RelayElementwiseUnaryRsqrtTranslation, self).__init__(ElementwiseUnaryRsqrtOp)
